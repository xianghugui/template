package com.base.web.bean.po.user;
 ...
 */
public class User extends GenericPo<Long> {
    ...
    public Set<Module> getModulesByPid(String pid, String level) {
        Set<Module> modules = getModules().stream()
                .filter(module -> module.getParentId().equals(pid) && hasAccessModuleAction(String.valueOf(module.getId()), level))
                .collect(Collectors.toCollection(() -> new LinkedHashSet<>()));
        return modules;
    }
