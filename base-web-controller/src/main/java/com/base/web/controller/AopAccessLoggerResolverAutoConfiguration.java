...
import com.base.web.core.logger.AccessLoggerPersisting;
import com.base.web.core.logger.Slf4jAccessLoggerPersisting;
...
@Configuration
@ConditionalOnProperty(name = "base.access-logger", havingValue = "true")
public class AopAccessLoggerResolverAutoConfiguration {
    ...
    static class AopAccessLoggerResolverConfiguration extends com.base.web.core.logger.AopAccessLoggerResolver {
        ...
        @Around(value = "execution(* com.base.web..controller..*Controller..*(..))||@annotation(com.base.web.core.logger.annotation.AccessLogger)")
