...
import com.base.web.oauth2.dao.OAuth2AccessMapper;
import com.base.web.oauth2.exception.AccessTimeoutException;
...
public class OAuth2ServiceImpl implements OAuth2Service {
    ...
    static final String cacheName = "base.oauth2";

    @Override
    public void addAccessToken(OAuth2Access auth2Access) {
        if (auth2Access.getId() == null) {
            auth2Access.setId(String.valueOf(OAuth2Access.createUID()));
        }
