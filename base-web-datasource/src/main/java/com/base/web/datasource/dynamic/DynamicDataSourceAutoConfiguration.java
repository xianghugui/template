...
@ComponentScan("com.base.web.datasource.dynamic")
public class DynamicDataSourceAutoConfiguration {
    ...
    public static class AnnotationDataSourceChangeConfiguration {
        ...
        @Around(value = "within(@com.base.web.datasource.dynamic.UseDataSource *)||@annotation(com.base.web.datasource.dynamic.UseDataSource)")
        ...
        @Around(value = "within(@com.base.web.datasource.dynamic.UseDefaultDataSource *)||@annotation(com.base.web.datasource.dynamic.UseDataSource)")
