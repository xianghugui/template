package com.base.web.core.session.simple;

import com.base.web.bean.po.user.User;
import com.base.web.core.session.AbstractHttpSessionManager;
...
public class SimpleHttpSessionManager extends AbstractHttpSessionManager {
    ...
    public void addUser(User user, HttpSession session) {
        ...
        userSessionStorage.put(String.valueOf(user.getId()), session);
