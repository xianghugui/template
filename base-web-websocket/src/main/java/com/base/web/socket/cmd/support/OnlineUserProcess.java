...
import com.base.web.core.session.HttpSessionManagerListener;
import com.base.web.socket.cmd.CMD;
import com.base.web.socket.message.WebSocketMessage;
...
public class OnlineUserProcess extends AbstractCmdProcessor implements HttpSessionManagerListener {
    private Set<Long> userList = Collections.synchronizedSet(new HashSet<>());
    ...
    protected void pushOnlineTotalToUser(Long userId, String callback) {
    ...
    @Override
    public void onUserLoginOut(Long userId, HttpSession session) {
