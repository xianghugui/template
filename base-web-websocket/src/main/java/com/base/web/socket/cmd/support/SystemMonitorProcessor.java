...
public class SystemMonitorProcessor extends AbstractCmdProcessor {
    ...
    private Map<Long, Publish> cpuPublish = new ConcurrentHashMap<>();
    private Map<Long, Publish> memPublish = new ConcurrentHashMap<>();
    ...
    protected void cancelPublish(Map<Long, Publish> publishMap, Long userId, WebSocketSession socketSession) {
