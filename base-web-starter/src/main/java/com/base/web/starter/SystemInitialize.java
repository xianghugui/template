...
import static com.base.web.starter.SystemVersion.Property.*;
...
public class SystemInitialize implements InitializingBean {
    ...
    private String installGroovyScriptPackage = "classpath*:com/base/web/start/scripts/install/install.groovy";
    private String installSqlScriptPackage    = "classpath*:com/base/web/start/scripts/install/sql/{db}/install.sql";

    private String upgradeGroovyScriptPackage = "classpath*:com/base/web/start/scripts/upgrade/*.groovy";
    private String upgradeSqlScriptPackage    = "classpath*:com/base/web/start/scripts/upgrade/sql/{db}/*.sql";

    private String initializeScriptPackage = "classpath*:com/base/web/start/scripts/initialize/initialize.groovy";
    private String initializeSqlPackage    = "classpath*:com/base/web/start/scripts/initialize/sql/{db}/initialize.sql";
