...
package com.base.web.service.impl.datasource;

import com.base.web.bean.po.datasource.DataSource;
import com.base.web.core.datasource.DynamicDataSource;
import com.base.web.core.exception.BusinessException;
import com.base.web.dao.datasource.DataSourceMapper;
import com.base.web.service.datasource.DataSourceService;
...
import static com.base.web.bean.po.GenericPo.Property.id;
import static com.base.web.bean.po.datasource.DataSource.Property.*;
    ...
    protected void checkDynamicDataSourceSupport() {
        if (dynamicDataSource == null)
            logger.warn("\ndynamicDataSource is not support! if you want use it,please import " +
                    ...
                    "            <artifactId>base-web-datasource</artifactId>\n" +
                    "       </dependency>" +
                    "\n<!--------------------------------------------------------->" +
                    "\n to pom.xml");
    }
